...
ai_t mq_update_init(mm_handle *mq, ai_t ai);
ai_t mq_update(mm_handle *mq, ai_t ai);
...
ai_t mq_update_init_nan(mm_handle *mq, ai_t ai);
ai_t mq_update_nan(mm_handle *mq, ai_t ai);
