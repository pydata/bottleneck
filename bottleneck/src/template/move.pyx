...
def move_sum(arr, int window, int minc=-1, int axis=-1):
    try:
        return mover(arr, window, minc, axis,
                     move_sum_float64,
                     move_sum_float32,
                     move_sum_int64,
                     move_sum_int32)
    except TypeError:
        return slow.move_sum(arr, window, minc, axis)


cdef ndarray move_sum_DTYPE0(ndarray a, int window, int minc, int axis,
...
def move_mean(arr, int window, int minc=-1, int axis=-1):
    try:
        return mover(arr, window, minc, axis,
                     move_mean_float64,
                     move_mean_float32,
        ...
        return slow.move_mean(arr, window, minc, axis)


@cython.cdivision(True)
cdef ndarray move_mean_DTYPE0(ndarray a, int window, int minc, int axis,
                              np.flatiter ita, Py_ssize_t stride,
                              Py_ssize_t length, int a_ndim,
                              np.npy_intp* y_dims, int int_input):
    # bn.dtypes = [['float64'], ['float32']]
...
def move_std(arr, int window, int minc=-1, int axis=-1, int ddof=0):
    try:
        return mover(arr, window, minc, axis,
                     move_std_float64,
                     move_std_float32,
        ...
        return slow.move_std(arr, window, minc, axis, ddof)


@cython.cdivision(True)
cdef ndarray move_std_DTYPE0(ndarray a, int window, int minc, int axis,
                             np.flatiter ita, Py_ssize_t stride,
                             Py_ssize_t length, int a_ndim,
...
def move_min(arr, int window, int minc=-1, int axis=-1):
    try:
        return mover(arr, window, minc, axis,
                     move_min_float64,
                     move_min_float32,
        ...
        return slow.move_min(arr, window, minc, axis)


cdef ndarray move_min_DTYPE0(ndarray a, int window, int minc, int axis,
                             np.flatiter ita, Py_ssize_t stride,
                             Py_ssize_t length, int a_ndim,
                             np.npy_intp* y_dims, int ignore):
    # bn.dtypes = [['float64'], ['float32']]
...
def move_max(arr, int window, int minc=-1, int axis=-1):
    try:
        return mover(arr, window, minc, axis,
                     move_max_float64,
                     move_max_float32,
        ...
        return slow.move_max(arr, window, minc, axis)


cdef ndarray move_max_DTYPE0(ndarray a, int window, int minc, int axis,
                             np.flatiter ita, Py_ssize_t stride,
                             Py_ssize_t length, int a_ndim,
                             np.npy_intp* y_dims, int ignore):
    # bn.dtypes = [['float64'], ['float32']]
...
@cython.cdivision(True)
cdef ndarray move_median_DTYPE0(ndarray a, int window, int minc, int axis,
                                np.flatiter ita, Py_ssize_t stride,
                                Py_ssize_t length, int a_ndim,
                                np.npy_intp* y_dims, int ignore):
...
cdef ndarray mover(arr, int window, int minc, int axis,
                   move_t move_float64,
                   move_t move_float32,
                   move_t move_int64,
                   move_t move_int32,
    ...
    if dtype == NPY_float64:
        y = move_float64(a, window, minc, axis, ita, stride, length, a_ndim,
                         y_dims, int_input)
    elif dtype == NPY_float32:
        y = move_float32(a, window, minc, axis, ita, stride, length, a_ndim,
                         y_dims,
                         int_input)
    elif dtype == NPY_int64:
        y = move_int64(a, window, minc, axis, ita, stride, length, a_ndim,
                       y_dims, int_input)
    elif dtype == NPY_int32:
        y = move_int32(a, window, minc, axis, ita, stride, length, a_ndim,
                       y_dims, int_input)
    else:
